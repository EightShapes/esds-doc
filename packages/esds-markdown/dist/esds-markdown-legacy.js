  ...
  return (
    ...
    function (_superclass) {
        ...
        if (!customElements.get('s-slot')) {
          ...
          function (_HTMLElement2) {
            ...
            function SSlot() {
              ...
              _this2._slotUpdateCompleted = new Promise(function (resolve, reject) {
                var id = setInterval(function () {
                  _this2._slotRenderAttempts++;

                  try {
                    if (_this2._slotRendered) {
                      clearInterval(id);
                      resolve();
                    } else if (_this2._slotRenderAttempts >= _this2._maxSlotRenderAttempts) {
      ...
      _createClass(_class, [{
        ...
        key: "_getUpdateComplete",
        value: function () {
          var _getUpdateComplete2 = _asyncToGenerator(
          /*#__PURE__*/
          regeneratorRuntime.mark(function _callee() {
            var slotPromises;
            return regeneratorRuntime.wrap(function _callee$(_context) {
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n      <div class=\"esds-markdown\" @slotchange=\"", "\"><s-slot>", "</s-slot></div>\n    "]);
...
/*#__PURE__*/
function (_Slotify) {
  _inherits(EsdsMarkdown, _Slotify);

  function EsdsMarkdown() {
    _classCallCheck(this, EsdsMarkdown);

    return _possibleConstructorReturn(this, _getPrototypeOf(EsdsMarkdown).apply(this, arguments));
  }

  _createClass(EsdsMarkdown, [{
    key: "handleSlotChange",
    value: function handleSlotChange(e) {
      var assignedContent = e.target.querySelector('s-assigned-wrapper');
      this.parsedMarkdown = this.constructor.parseMarkdown(assignedContent.innerHTML);
      assignedContent.innerHTML = '';
    }
  }, {
    key: "render",
    value: function render() {
      return html(_templateObject(), this.handleSlotChange, this.parsedMarkdown);
    }
  }], [{
    key: "parseMarkdown",
    value: function parseMarkdown(input) {
      return marked(stripIndent(input)); //     env.addFilter('markdown', function(string, includeWrapper, wrapperClass) {
