...
/*#__PURE__*/
function () {
  function EsdsColorUtils() {
    _classCallCheck(this, EsdsColorUtils);
  }
...
function _templateObject5() {
  var data = _taggedTemplateLiteral(["\n              <span class=\"esds-tint-swatch__hex-label\">", "</span>\n            "]);
...
function _templateObject4() {
  var data = _taggedTemplateLiteral(["\n      <span class=\"esds-tint-swatch__label\">\n        <span class=\"esds-tint-swatch__label-text\">", "</span>\n        ", "\n      </span>\n    "]);
...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["\n        <span\n          class=\"esds-tint-swatch__contrast-ratio esds-tint-swatch__contrast-ratio--", "\"\n        >\n          ", "\n        </span>\n      "]);
...
function (_LitElement) {
  _inherits(EsdsTintSwatch, _LitElement);

  _createClass(EsdsTintSwatch, null, [{
    key: "properties",
    get: function get() {
      return {
        accessibilityRating: {
          type: Boolean,
          attribute: 'accessibility-rating'
        },
        ...
        colorRole: {
          type: String,
          attribute: 'color-role'
        },
        contrastRatio: {
          type: Boolean,
          attribute: 'contrast-ratio'
        },
        contrastRatioValue: {
          type: String,
        ...
        testHexColor: {
          type: String,
          attribute: 'test-hex-color'
        }
      };
    }
  }]);

  function EsdsTintSwatch() {
    var _this;
  ...
  _createClass(EsdsTintSwatch, [{
    ...
    value: function calculateContrastRatio() {
      var testColor = this.testHexColor ? this.testHexColor : this.mostAccessibleTestColor;
      return EsdsColorUtils.contrastRatioForHex(this.hex, testColor);
    }
  }, {
    key: "renderCodeSnippet",
    value: function renderCodeSnippet() {
      if (this.codeSnippet) {
        return html(_templateObject(), unsafeHTML(this.codeSnippet));
      } else {
        return '';
      }
    }
  }, {
    key: "renderContrastRatio",
    value: function renderContrastRatio() {
      if (this.accessibilityRating || this.accessibilityRatingValue || this.contrastRatio || this.contrastRatioValue) {
        var contrastRatioText = '';
        ...
        if (this.contrastRatio || this.contrastRatioValue) {
          contrastRatioText += contrastRatioText.length > 0 ? ", ".concat(this.calculatedContrastRatio) : this.calculatedContrastRatio;
        }

        return html(_templateObject2(), this.calculatedAccessibilityRating, contrastRatioText);
      } else {
        return '';
      }
    }
  }, {
    key: "renderHtmlExample",
    value: function renderHtmlExample() {
      if (this.htmlExample) {
        return html(_templateObject3(), unsafeHTML(this.htmlExample));
      } else {
        return '';
      }
    }
    ...
    value: function renderLabel() {
      ...
      var labelText = this.label || this.hex.toUpperCase();
      return html(_templateObject4(), labelText, !this.hiddenHexLabel ? html(_templateObject5(), this.hex) : '');
    }
  }, {
    key: "render",
    value: function render() {
      var backgroundColor = this.backgroundColor;
      var labelColor = this.labelColor ? this.labelColor : this.foregroundColor;
      return html(_templateObject6(), this.className, backgroundColor, labelColor, this.renderLabel(), this.renderHtmlExample(), this.renderCodeSnippet(), this.renderContrastRatio());
    }
  }, {
    key: "backgroundColor",
    get: function get() {
    ...
    key: "calculatedAccessibilityRating",
    get: function get() {
    ...
    key: "className",
    get: function get() {
      var className = 'esds-tint-swatch';
