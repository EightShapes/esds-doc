...
/*#__PURE__*/
function (_Slotify) {
  _inherits(EsdsIconSwatch, _Slotify);

  function EsdsIconSwatch() {
    _classCallCheck(this, EsdsIconSwatch);

    return _possibleConstructorReturn(this, _getPrototypeOf(EsdsIconSwatch).apply(this, arguments));
  }

  _createClass(EsdsIconSwatch, [{
    key: "render",
    value: function render() {
      return html(_templateObject(), this.label);
    }
  }], [{
    key: "properties",
    get: function get() {
