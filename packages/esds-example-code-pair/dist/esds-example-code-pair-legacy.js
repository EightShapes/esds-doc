...
var acorn = createCommonjsModule(function (module, exports) {
  ...
  exports.identifierMatch = new RegExp("(?:\\\\u[0-9a-fA-F]{4}|[" + baseASCIIidentifierChars + nonASCIIidentifierStartChars + nonASCIIidentifierChars + "])+"); // Whether a single character denotes a newline.
...
var Tokenizer$1 = function Tokenizer$1(input_string, options) {
...
var Options$2 = options$1$1.Options;
...
var defaultOptions$1 = function defaultOptions$1() {
...
var Tokenizer$3 = function Tokenizer$3(input_string, options) {
...
var defaultOptions$2 = function defaultOptions$2() {
...
var directives$1$1 = new WeakMap();
/**
...
var directive = function directive(f) {
  return function () {
    ...
    directives$1$1.set(d, true);
    return d;
  };
};

var isDirective$1 = function isDirective(o) {
  return typeof o === 'function' && directives$1$1.has(o);
};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
...
try {
  ...
  window.addEventListener('test', _options, _options); // tslint:disable-next-line:no-any

  window.removeEventListener('test', _options, _options);
} catch (_e) {}
...
var html$2 = function html$2(strings) {
  for (var _len = arguments.length, values = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
    values[_key - 1] = arguments[_key];
  }
...
var render$1$1 = function render$1(result, container, options) {
  if (!options || _typeof(options) !== 'object' || !options.scopeName) {
    throw new Error('The `scopeName` option is required.');
  }
...
function (_HTMLElement) {
  ...
  function UpdatingElement() {
    ...
    _this3 = _possibleConstructorReturn(this, _getPrototypeOf(UpdatingElement).call(this));
    _this3._updateState = 0;
    _this3._instanceProperties = undefined;
    _this3._updatePromise = microtaskPromise$1;
  ...
  _createClass(UpdatingElement, [{
    ...
    value: function _attributeToProperty(name, value) {
      ...
      if (propName !== undefined) {
        var _options2 = ctor._classProperties.get(propName) || defaultPropertyDeclaration$1; // mark state reflecting


        this._updateState = this._updateState | STATE_IS_REFLECTING_TO_PROPERTY$1;
        this[propName] = // tslint:disable-next-line:no-any
        ctor._propertyValueFromAttribute(value, _options2); // mark state not reflecting
    ...
    value: function _requestUpdate(name, oldValue) {
      ...
      if (name !== undefined) {
        ...
        var _options3 = ctor._classProperties.get(name) || defaultPropertyDeclaration$1;

        if (ctor._valueHasChanged(this[name], oldValue, _options3.hasChanged)) {
          if (!this._changedProperties.has(name)) {
            this._changedProperties.set(name, oldValue);
          } // Add to reflecting properties set.
          // Note, it's important that every change has a chance to add the
          ...
          if (_options3.reflect === true && !(this._updateState & STATE_IS_REFLECTING_TO_PROPERTY$1)) {
            if (this._reflectingProperties === undefined) {
              this._reflectingProperties = new Map();
            }

            this._reflectingProperties.set(name, _options3);
          }
        } else {
          // Abort the request if the property should not be considered changed.
          shouldRequestUpdate = false;
...
function (_LitElement) {
  ...
  function EsdsCodeSnippet() {
    ...
    _this11 = _possibleConstructorReturn(this, _getPrototypeOf(EsdsCodeSnippet).call(this));
    _this11.defaultClass = 'esds-code-snippet-v1';
    _this11.baseModifierClass = 'esds-code-snippet--';
    _this11.stylesheet = 'esds-code-snippet.css';
    _this11.defaultSource = '<h1>Hello World</h1>'; // State

    _this11.codeCopied = false; // Default prop values

    _this11.codeCopiedText = 'Copied to clipboard';
    _this11.copyButtonText = 'Copy Code';
    _this11.copyable = 'true';
    _this11.source = _this11.defaultSource;
    _this11.language = 'markup';
    _this11.preformatted = false;
    _this11.slotContent = _this11.innerHTML.trim().length > 0 ? _this11.innerHTML.trim() : undefined;
    return _this11;
  }
  ...
  _createClass(EsdsCodeSnippet, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee3(wcSource) {
    ...
    value: function renderCopyButton() {
      ...
      var copyButton = html$2(_templateObject(), this.copyButtonText);

      if (this.copyable === 'true') {
        return html$2(_templateObject2(), this.codeCopiedText, this.copyCodeToClipboard, copyButton);
      } else {
        return '';
      }
    }
    ...
    value: function render() {
      ...
      if (sources) {
        ...
        sources.forEach(function (s) {
          codeSnippets.push("\n          <esds-tab-panel label=\"".concat(s.language, "\">\n            ").concat(_this12.renderCodeSnippet(s.source, s.language, s.filename), "\n          </esds-tab-panel>\n        "));
        });
...
var commentMarker$1 = " ".concat(marker$2, " ");
/**
 * The return type of `html`, which holds a Template and the values from
 * interpolated expressions.
 */
    ...
    value: function getHTML() {
      ...
      for (var i = 0; i < l; i++) {
        ...
        if (attributeMatch === null) {
          ...
          // <!-- foo=${'bar'}--> are handled correctly in the attribute branch
          // below.
          html += s + (isCommentBinding ? commentMarker$1 : nodeMarker$2);
        } else {
          // For attributes we use just a marker sentinel, and also append a
          // $lit$ suffix to the name to opt-out of attribute-specific parsing
          // that IE and Edge do for style and certain SVG attributes.
...
/*#__PURE__*/
function (_Slotify) {
  _inherits(EsdsExampleCodePair, _Slotify);

  function EsdsExampleCodePair() {
    _classCallCheck(this, EsdsExampleCodePair);

    return _possibleConstructorReturn(this, _getPrototypeOf(EsdsExampleCodePair).apply(this, arguments));
  }
