...
gulp.task('markup:concatenate-library-macros', function(){
    return gulp.src(['src/library/components/**/*.njk', `!src/library/components/library_macros.njk`])
        .pipe(concat(`library_macros.njk`))
...
gulp.task('markup:concatenate-doc-library-macros', function(){
    return gulp.src(['src/doc_library/components/**/*.njk', `!src/doc_library/components/doc_library_macros.njk`])
        .pipe(concat(`doc_library_macros.njk`))
        .pipe(concat.header('{# DO NOT EDIT: This file is automatically generated by the project\'s build task #}\n'))
...
gulp.task('watch:markup:library-macros', function(){
    return gulp.watch(['src/library/components/**/*.njk', `!src/library/components/library_macros.njk`], gulp.series('markup:concatenate-library-macros', 'markup:compile-docs', 'browser-sync-reload'));
});

gulp.task('watch:markup:doc-library-macros', function(){
    return gulp.watch(['src/doc_library/components/**/*.njk', `!src/doc_library/components/doc_library_macros.njk`], gulp.series('markup:concatenate-doc-library-macros', 'markup:compile-docs', 'browser-sync-reload'));
});
...
gulp.task('clean:markup:concatenated-macros', function(){
    return(del([`src/library/components/library_macros.njk`, `src/doc_library/components/doc_library_macros.njk`]));
});
